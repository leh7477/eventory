...
export function seoBodyVariants(name) {
  return [
    ...
    [
      ...
      `이벤트랜드는 ${name} 대여부터 시작해 행사 콘셉트에 맞춘 브랜드 래핑과 ${name} 맞춤 제작까지 한 번에 준비합니다. 표준형 ${name}렌탈은 물론 대형 사이즈나 특수 규격의 ${name}제작도 문의하실 수 있습니다.`,
    ...
    [
      ...
      `이벤트랜드(EVENT LAND)는 ${name} 렌탈·대여는 물론 브랜드 로고와 디자인을 입힌 커스텀 래핑, 그리고 ${name} 맞춤 제작을 함께 제공합니다. 행사 규모가 크다면 대형 ${name} 제작으로도 대응합니다.`,
