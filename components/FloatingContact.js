  ...
  return (
    <div className="fixed bottom-5 right-4 z-40 flex flex-col items-stretch gap-2.5 sm:bottom-7 sm:right-6">
      ...
      <Link
        href="/contact"
        aria-label="견적 문의"
        className="flex items-center justify-center gap-2 rounded-full bg-[#3457dc] px-5 py-3.5 text-sm font-bold text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-[#2b48c0] hover:shadow-xl sm:px-6 sm:py-4 sm:text-base"
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
